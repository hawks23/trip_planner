...
DEFAULT_ORIGIN_IATA = os.getenv("DEFAULT_ORIGIN_IATA", "DAC")  # Default origin for the place of travel if not mentioned in the prompt. It can be DAC, CMB, or any other airport code.
BASE_URL = "http://api.aviationstack.com/v1/flights"

AIRPORTS = airportsdata.load("IATA")  # Load airports data with IATA codes
